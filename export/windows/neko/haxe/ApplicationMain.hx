...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Lisandro", "Castlevania", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Castlevania";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Castlevania", null, { width: 256, height: 240 });
