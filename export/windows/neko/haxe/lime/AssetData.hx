...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/data/test1.oel", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/data/test1.oep", "assets/data/test1.oep");
			type.set ("assets/data/test1.oep", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/images/ataque del lingera (1).png", "assets/images/ataque del lingera (1).png");
			type.set ("assets/images/ataque del lingera (1).png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/EnemiesMUsulman (1).png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/Enemigo negro esclavo (1).png", "assets/images/Enemigo negro esclavo (1).png");
			type.set ("assets/images/Enemigo negro esclavo (1).png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/lampara para el mapa (1).png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/lingera- Enemies (2).png", "assets/images/lingera- Enemies (2).png");
			type.set ("assets/images/lingera- Enemies (2).png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/lvlTEST.png", "assets/images/lvlTEST.png");
			type.set ("assets/images/lvlTEST.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/Mapa (2).png", "assets/images/Mapa (2).png");
			type.set ("assets/images/Mapa (2).png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/wallpaper1.png", Reflect.field (AssetType, "image".toUpperCase ()));
