...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/lifebar.png", AssetType.IMAGE);
		...
		type.set ("assets/images/Reja.png", AssetType.IMAGE);
