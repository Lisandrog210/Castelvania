...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/PlataformaQueSemueve.png", AssetType.IMAGE);
		...
		type.set ("assets/images/WiskiArrojadizo.png", AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/PlataformaQueSemueve.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/WiskiArrojadizo.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
