...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/test1.oel", __ASSET__assets_data_test1_oel);
		type.set ("assets/data/test1.oel", AssetType.TEXT);
		className.set ("assets/data/test1.oep", __ASSET__assets_data_test1_oep);
		...
		className.set ("assets/images/lvlTEST.png", __ASSET__assets_images_lvltest_png);
		...
		className.set ("assets/images/wallpaper1.png", __ASSET__assets_images_wallpaper1_png);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_test1_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_test1_oep extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_lvltest_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_wallpaper1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/test1.oel") #if display private #end class __ASSET__assets_data_test1_oel extends lime.utils.Bytes {}
@:file("assets/data/test1.oep") #if display private #end class __ASSET__assets_data_test1_oep extends lime.utils.Bytes {}
...
@:image("assets/images/lvlTEST.png") #if display private #end class __ASSET__assets_images_lvltest_png extends lime.graphics.Image {}
...
@:image("assets/images/wallpaper1.png") #if display private #end class __ASSET__assets_images_wallpaper1_png extends lime.graphics.Image {}
